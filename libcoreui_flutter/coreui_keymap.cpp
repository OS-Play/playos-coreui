...
static std::unordered_map<int, uint64_t> s_physicalKeys = {
...
static std::unordered_map<int, uint64_t> s_logicalKeys = {
...
{
    return s_physicalKeys[key];
}

uint64_t coreui_getLogicalKeyboardKey(int key)
{
    return s_logicalKeys[key];
}
